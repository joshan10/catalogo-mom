...
const PRODUCTS = [
  ...
  },
  {
    ...
    shortDesc: 'Cajita negra con rosas, chocolates Ferrero y cartel "Feliz Día Mamá".',
    description: 'Un tierno regalo pensado especialmente para mamá. Esta cajita negra elegante con lazo rojo y mariposa dorada se abre para mostrar rosas artesanales rojas, chocolates Ferrero Rocher, un pequeño detalle de aretes y cadena y un cartel con flores que dice "Feliz Día Mamá". Un detalle que expresa todo tu amor en un pequeño espacio lleno de significado.',
    includes: ['Rosas artesanales rojas', 'Chocolates Ferrero Rocher', 'Aretes y cadena', 'Cartel "Feliz Día Mamá"', 'Mariposa dorada', 'Lazo rojo'],
  ...
  },
  {
    ...
    price: 'Consultar',
    badge: 'Deluxe',
    shortDesc: 'Caja rosa con desayuno gourmet: fresas, granola, jugo, sándwich y Ferrero Rocher.',
    description: 'La presentación más elegante para un desayuno sorpresa. Una sofisticada caja rosa con ventana transparente contiene un desayuno gourmet cuidadosamente organizado: fresas frescas con lazo, granola con frutas del bosque, postre de torta tres leches, sándwich de jamón queso y vegetales acompañado con unos rollitos de queso jamón y dos tipos de carnes, jugo natural, yogurt artesanal y chocolates Ferrero Rocher. Decorada con flores, lazos rosados y tarjeta "MADRE". Un regalo digno de una reina.',
    includes: ['Fresas frescas', 'Granola gourmet', 'Torta tres leches', 'Sándwich de jamón queso y vegetales', 'Jugo natural', 'Yogurt artesanal', 'Chocolates Ferrero Rocher', 'Caja premium rosa', 'Tarjeta "MADRE"'],
    images: ['caja-desayuno-rosa-1.jpeg', 'caja-desayuno-rosa-2.jpeg'],
  },
  {
    id: 'bandeja-torta',
  ...
  {
    id: 'bandeja-spa',
    name: 'Bandeja desayuno Relax',
    category: 'desayunos',
    price: 'Consultar',
    shortDesc: 'Bandeja rosa con vela aromática, vino JP Chenet, flores, dulces y tarjeta "MADRE".',
    description: 'Un momento especial para mamá. Esta hermosa bandeja rosa con cintas de satén incluye yogur, jugo de naranja natural, vino espumoso jp chenet, sándwich de jamón y queso, mini postre tres leches, porción de fruta, chocolate Ferrero, galletas integrales con frutos rojos, tarjeta "MADRE" (Maravillosa, Amorosa, Dedicada, Radiante, Ejemplar). Un regalo que invita a relajarse y disfrutar.',
    includes: ['Yogur', 'Jugo de naranja natural', 'Vino espumoso jp chenet', 'Sándwich de jamón y queso', 'Mini postre tres leches', 'Porción de fruta', 'Chocolate Ferrero', 'Galletas integrales con frutos rojos', 'Tarjeta "MADRE"', 'Bandeja con cintas'],
    images: ['bandeja-spa-1.jpeg', 'cofre-negro-2.jpeg'],
  },
  {
    id: 'caja-oso-morado',
    name: 'Caja Oso y Globos Morados',
    category: 'especiales',
    price: 'Consultar',
    badge: 'Nuevo',
    shortDesc: 'Hermosa caja lila con oso de peluche, globos corazón morados, flores y chocolates.',
    description: 'Un detalle tierno y espectacular. Caja cilíndrica lila que revela un adorable osito de peluche, rodeado de delicadas flores artificiales y chocolates dorados. Coronado con globos en forma de corazón morados y rosas, más un globo "Feliz Día". Perfecto para demostrar tu amor.',
    includes: ['Oso de peluche', 'Globos corazón morados y rosas', 'Globo "Feliz Día"', 'Flores artificiales', 'Caja lila con lazo', 'Chocolates'],
    images: ['corazon-oso-morado-6.jpeg', 'corazon-oso-morado-7.jpeg'],
  },
  {
    id: 'ramo-reina',
    name: 'Ramo Reina Fucsia',
    category: 'ramos',
    price: 'Consultar',
    badge: 'Elegante',
    shortDesc: 'Ramo de rosas fucsias y blancas en satín con corona dorada y chocolates.',
    description: 'Para la reina de tu vida. Un hermoso ramo elaborado con rosas en cinta satín colores fucsia brillante y blanco, entrelazadas con deliciosos chocolates premium. En el centro, una tiara dorada con perlas y delicadas mariposas. Envuelto en un exquisito papel con corazones dorados y atado con un gran lazo fucsia.',
    includes: ['Rosas fucsias y blancas en satín', 'Corona dorada con perlas', 'Chocolates premium', 'Mariposas decorativas', 'Envoltorio papel premium', 'Lazo fucsia'],
    images: ['flores-reina-4.jpeg', 'flores-reina-5.jpeg'],
  },
  {
    id: 'caja-i-love-you',
    name: 'Caja "I Love You"',
    category: 'especiales',
    price: 'Consultar',
    badge: 'Romántico',
    shortDesc: 'Espectacular caja en forma de letras "I U" y corazón con rosas rojas, blancas y chocolates.',
    description: 'El mensaje de amor más grande. Esta caja roja en la icónica forma de "I Love You" contiene un arreglo impecable de rosas rojas y blancas, acompañadas de exquisitos chocolates dorados dentro del corazón central. Rematado con una elegante tiara dorada y mariposas doradas en 3D. Un regalo enorme que no se olvidará.',
    includes: ['Caja gigante "I Love You"', 'Rosas rojas y blancas de exhibición', 'Chocolates dorados', 'Corona dorada', 'Mariposas doradas en 3D'],
    images: ['caja-i-love-you.jpeg'],
  },
  {
    id: 'caja-sorpresa-reina',
    name: 'Caja Sorpresa Reina',
    category: 'cofres',
    price: 'Consultar',
    badge: 'Premium',
    shortDesc: 'Caja negra que se despliega con rosas, chocolates dorados y cajón secreto.',
    description: 'Una sorpresa elegante de nivel superior. Esta misteriosa caja negra atada con un lazo rojo se despliega al abrirse para revelar un hermoso corazón de rosas rojas, adornadas con una tiara real y una mariposa dorada. Además, cuenta con un cajón secreto en la parte inferior ideal para esconder deliciosos chocolates dorados o un regalo adicional. Un detalle lleno de glamour.',
    includes: ['Caja de lujo desplegable negra', 'Rosas rojas', 'Chocolates dorados', 'Cajón secreto inferior', 'Corona dorada y mariposa', 'Lazo satín rojo'],
    images: ['caja-sopresa-reina-1.jpeg', 'caja-sopresa-reina-2.jpeg'],
  },
];
