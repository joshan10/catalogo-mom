...
const PRODUCTS = [
  {
    ...
    images: ['cofre-negro-1.jpeg', 'cofre-negro-2.jpeg', 'cofre-negro-3.jpeg', 'cofre-negro-4.jpeg'],
  },
  {
    id: 'cofre-rojo',
    name: 'Cofre Pasión Real',
    category: 'cofres',
    price: 'Consultar',
    badge: 'Premium',
    shortDesc: 'Cofre rojo desplegable con rosas rojas y blancas, chocolates Ferrero Rocher y corona dorada.',
    description: 'Un majestuoso cofre en color rojo intenso que se abre para revelar un espectáculo floral. Rosas artesanales rojas y blancas flanquean un corazón central repleto de chocolates Ferrero Rocher, coronado con una elegante corona dorada con perlas. Mariposas holográficas y lazos de satén completan este regalo que dice "Te Amo" sin palabras.',
    includes: ['Rosas rojas y blancas', 'Chocolates Ferrero Rocher', 'Corona dorada con perlas', 'Mariposas decorativas', 'Cinta de satén'],
    images: ['cofre-rojo-1.jpeg', 'cofre-rojo-2.jpeg'],
  },
  {
    id: 'cofre-rosa',
  ...
  {
    id: 'caja-sorpresa',
    name: 'Caja Sorpresa Ferrero',
    category: 'cofres',
    price: 'Consultar',
    shortDesc: 'Caja roja con 9 chocolates Ferrero Rocher, rosas artesanales y mariposa decorativa.',
    description: 'Un detalle compacto pero lleno de dulzura. Esta elegante caja roja con lazo de satén se abre para revelar 9 exquisitos chocolates Ferrero Rocher junto a hermosas rosas artesanales y una delicada mariposa decorativa. Ideal para sorprender con un toque de elegancia sin necesidad de grandes gestos.',
    includes: ['9 chocolates Ferrero Rocher', 'Rosas artesanales', 'Mariposa decorativa', 'Lazo de satén', 'Caja gift box'],
    images: ['caja-sorpresa-1.jpeg', 'caja-sorpresa-2.jpeg', 'caja-sorpresa-3.jpeg'],
  },
  {
    id: 'cajita-mama',
    ...
    description: 'Un tierno regalo pensado especialmente para mamá. Esta cajita negra elegante con lazo rojo y mariposa dorada se abre para mostrar rosas artesanales rojas, chocolates Ferrero Rocher y un cartel con flores que dice "Feliz Día Mamá". Un detalle que expresa todo tu amor en un pequeño espacio lleno de significado.',
    includes: ['Rosas artesanales rojas', 'Chocolates Ferrero Rocher', 'Cartel "Feliz Día Mamá"', 'Mariposa dorada', 'Lazo rojo'],
    images: ['cajita-mama-1.jpeg'],
  },
  {
    id: 'corazon-oso',
    ...
    images: ['corazon-oso-1.jpeg', 'corazon-oso-2.jpeg', 'corazon-oso-3.jpeg', 'corazon-oso-4.jpeg', 'corazon-oso-5.jpeg', 'corazon-oso-6.jpeg', 'corazon-oso-7.jpeg'],
  },
  {
    id: 'arreglo-mama',
  ...
  },
  {
    ...
    images: ['ramo-rosas-1.jpeg', 'ramo-rosas-2.jpeg'],
  },
  {
    id: 'canasta-flores',
  ...
  },
  {
    ...
    description: 'Despierta con una sonrisa de oreja a oreja. Esta generosa bandeja de madera sobre patas trae un desayuno completo: bowl de fresas frescas, bowl de granola con frutas, arroz con leche, rebanadas de pan, jugo natural, chocolates Ferrero Rocher, frutos secos surtidos y un adorable oso de peluche grande con lazo burgundy. Coronado con un globo burbuja "Te Amo" con corazones. Un despertar mágico.',
    includes: ['Oso de peluche grande', 'Fresas frescas', 'Granola con frutas', 'Arroz con leche', 'Pan artesanal', 'Jugo natural', 'Chocolates Ferrero Rocher', 'Frutos secos', 'Globo "Te Amo"', 'Lazos burgundy'],
  ...
  },
  {
    ...
    description: 'Celebra un cumpleaños de la forma más dulce. Este cajón de madera decorado con cinta turquesa incluye fresas frescas con chocolate, granola con frutas, sandwiches artesanales, té Hatsu, jugo natural y dulces variados. Coronado con un colorido globo "Feliz Cumpleaños" en tono menta. Un desayuno sorpresa que hará de ese día uno inolvidable.',
